...
HD_PWD='E:/School/3rdYear/Semester-I/DSD/Labs/Practicum/Practicum.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NonSeqCounter_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NonSeqCounter_4bit.tcl -notrace
