...
HD_PWD='E:/School/3rdYear/Semester-I/DSD/Labs/Practicum/Practicum.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NonSeqCounter_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NonSeqCounter_4bit.tcl
